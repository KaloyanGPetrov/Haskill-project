...
namespace Haskill_project.Controllers
{
    public class PricesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FoodName,PriceForFood")] Price price)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FoodName,PriceForFood")] Price price)
        {
            if (id != price.Id)
            {
                return NotFound();
